...
import cn.lcq517.travel.service.RouteService;
import cn.lcq517.travel.service.impl.FavoriteServiceImpl;
import cn.lcq517.travel.service.impl.RouteServiceImpl;
...
public class RouteServlet extends BaseServlet {
    ...
    public void pageQuery(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String pageSizeStr = request.getParameter("pageSzie");
    ...
    public void myFavorite(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        //3.调用service查询数据 返回PageBean对象
        PageBean<Route> pb = favoriteService.findMyFavorite(uid, currentPage, pageSize);
